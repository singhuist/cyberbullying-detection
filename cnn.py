...
for train_index, test_index in shuffdata.split(padded_docs,labels):
	...
	#history, pred = awekar_models.cnn(trainX, trainY, valX, valY, testX, testY, vocab_size, padlength, e, embedding_matrix, num_classes = 2, learn_rate = 0.01)
	history, pred = awekar_models.cnn(trainX, trainY, valX, valY, testX, testY, e, embedding_matrix)
